...
import emavalidator.errors.CellErrorSeasonNumber;
...
public class SeasonNumber extends AbstractColumnDefinition
{
    ...
    public void buildValidators()
    {
        this.validators.add(new CellValidatorRegexFormat(new String[]{
                            ...
                            CellErrorSeasonNumber.EXPECTED_VALUES_SEASON_NUMBER));
    }
}
