...
public class CellErrorDateValue extends AbstractErrorEntry
{
    ...
    public static final String DATE_FORMAT_ERROR = "Date Value Error: The value for this cell must be a specific date format.";
    ...
    public static final String EXPECTED_VALUES        = "Dates must be in YYYY-MM-DD format.";
