...
public class Tier extends AbstractColumnDefinition
{
    ...
    public void buildValidators()
    {
        this.validators.add(new CellValidatorRegexFormat(new String[] {
                            ...
                            false,
                            ErrorLevel.ERROR,
                            CellErrorSpecificValueFormat.NUMBER_LETTER_FORMAT_ERROR,
                            CellErrorTier.EXPECTED_TIER_VALUES));
    }
}
