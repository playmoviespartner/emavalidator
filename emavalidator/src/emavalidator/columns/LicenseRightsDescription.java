...
import emavalidator.errors.CellErrorLicenseRightsDescription;
import emavalidator.validators.CellValidatorRegexFormat;
import emavalidator.validators.ValidatorUtils;

public class LicenseRightsDescription extends AbstractColumnDefinition
{
    @Override
    public void buildValidators()
    {
        this.validators.add(new CellValidatorRegexFormat(new String[] {
                            ValidatorUtils.LICENSE_RIGHTS_DESCRIPTION_VALUES_REGEX,
                            ValidatorUtils.EMPTY_STRING_REGEX},
                            false,
                            ErrorLevel.WARNING,
                            CellErrorLicenseRightsDescription.ERROR_MESSAGE_LICENSE_RIGHTS_DESCRIPTION,
                            CellErrorLicenseRightsDescription.EXPECTED_LICENSE_RIGHTS_DESCRIPTION));
    }
}
