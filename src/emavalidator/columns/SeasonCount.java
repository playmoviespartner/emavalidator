...
import emavalidator.errors.CellErrorSeasonCount;
...
public class SeasonCount extends AbstractColumnDefinition
{
    @Override
    public void buildValidators()
    {
        this.validators.add(new CellValidatorRegexFormat(new String[]{
                            ...
                            CellErrorSeasonCount.EXPECTED_VALUES_SEASON_COUNT));
    }
}
