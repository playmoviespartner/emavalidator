...
/**
 * ExceptionsFlag is apparently different from ExceptionFlag under movies tab.
 * 
 * @author ckha
 *
 */
public class ExceptionsFlag extends AbstractColumnDefinition
{
    @Override
    public void buildValidators()
    {
        this.validators.add(new CellValidatorRegexFormat(new String[] {
                            ValidatorUtils.YES_OR_NO_ONLY_REGEX,
                            ValidatorUtils.EMPTY_STRING_REGEX},
                            false,
                            ErrorLevel.ERROR,
                            CellErrorSpecificValueFormat.YES_OR_NO_ONLY_ERROR,
                            CellErrorSpecificValueFormat.EXPECTED_VALUES_YESNO));
    }
}
