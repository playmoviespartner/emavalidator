...
import emavalidator.errors.CellErrorPriceValue;
...
public class PriceValue extends AbstractColumnDefinition
{
    @Override
    public void buildValidators()
    {
        this.validators.add(new CellValidatorRegexFormat(new String[]{
                            ValidatorUtils.VALID_TIER_CATEGORY_VALUES_REGEX,
                            ...
                            CellErrorPriceValue.EXPECTED_PRICE_VALUE));
    }
}
