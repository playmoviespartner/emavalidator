...
import emavalidator.errors.CellErrorEpisodeNumber;
...
public class EpisodeNumber extends AbstractColumnDefinition
{
    @Override
    public void buildValidators()
    {
        this.validators.add(new CellValidatorRegexFormat(new String[]{
                ValidatorUtils.NUMBER_FORMAT_REGEX,
                ValidatorUtils.EMPTY_STRING_REGEX},
                false,
                ErrorLevel.ERROR,
                CellErrorSpecificValueFormat.EXPECTED_VALUES_NUMBER,
                CellErrorEpisodeNumber.EXPECTED_VALUES_EPISODE_NUMBER));
    }
}
