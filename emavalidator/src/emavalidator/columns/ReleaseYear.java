...
public class ReleaseYear extends AbstractColumnDefinition
{
    @Override
    public void buildValidators()
    {
        this.validators.add(new CellValidatorRegexFormat(new String[]{
                            ValidatorUtils.YEAR_ONLY_FORMAT_REGEX,
                            ValidatorUtils.EMPTY_STRING_REGEX},
                            false,
                            ErrorLevel.ERROR,
                            CellErrorDateValue.YEAR_FORMAT_ERROR,
                            CellErrorDateValue.EXPECTED_VALUES_YEAR));
    }
}
