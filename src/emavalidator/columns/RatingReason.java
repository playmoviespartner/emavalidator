...
import emavalidator.errors.CellErrorRatingReason;
...
public class RatingReason extends AbstractColumnDefinition
{
    @Override
    public void buildValidators()
    {
        this.validators.add(new CellValidatorRegexFormat(new String[]{
                            ...
                            CellErrorRatingReason.EXPECTED_RATING_REASON));
    }
}
