...
public class CellErrorLicenseRightsDescription extends AbstractErrorEntry
{
    ...
    public static final String EXPECTED_LICENSE_RIGHTS_DESCRIPTION = "New Release, Library, Mega-Library, DD-Theatrical, Pre-Theatrical, Early EST, Preorder EST, Early VOD, Preorder VOD, Next Day TV, Season Only, DTV, DD-DVD, Free, POD";
