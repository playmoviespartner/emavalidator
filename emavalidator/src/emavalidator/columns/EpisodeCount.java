...
import emavalidator.errors.CellErrorEpisodeCount;
...
public class EpisodeCount extends AbstractColumnDefinition
{
    @Override
    public void buildValidators()
    {
        this.validators.add(new CellValidatorRegexFormat(new String[]{
                            ...
                            false,
                            ErrorLevel.ERROR,
                            CellErrorSpecificValueFormat.NUMBER_FORMAT_ERROR,
                            CellErrorEpisodeCount.EXPECTED_VALUES_EPISODE_COUNT));
    }
}
