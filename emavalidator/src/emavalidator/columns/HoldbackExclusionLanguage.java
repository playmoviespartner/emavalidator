...
import emavalidator.errors.CellErrorHoldbackLanguage;
...
public class HoldbackExclusionLanguage extends AbstractColumnDefinition
{
    @Override
    public void buildValidators()
    {
        this.validators.add(new CellValidatorRegexFormat(new String[]{
                            ValidatorUtils.COMMA_SEPARATED_VALUES_REGEX,
                            ValidatorUtils.EMPTY_STRING_REGEX},
                            false,
                            ErrorLevel.ERROR,
                            CellErrorSpecificValueFormat.COMMA_SEPARATED_VALUES_ERROR,
                            CellErrorHoldbackLanguage.EXPECTED_HOLDBACK_VALUES));
    }
}
